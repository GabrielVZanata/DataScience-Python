...
diagramas Tensão x Deformação, não havendo garantia de que funcionará para outros 
tipos de ensaio.

Para que o código possa funcionar adequadamente é necessário prestar atenção na
formatação dos dados originais. As funções do pacote esperam um formato específico
que deve ser idêntico ao do dataset "Tracao_acos.csv" disponível neste repositório.
Espera-se que esta seja a formatação padrão de dados oriundos da Shimadzu. Caso
